...
class GameConstants:
    def __init__(self, N: int = 30):
        for key, value in self.get_game_constants(N).items():
            setattr(self, key, value)
    
    def get_game_constants(self, N: int):
        """
        Retourne toutes les constantes du jeu pour une grille N×N.
        """
