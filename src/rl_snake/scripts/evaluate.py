...
def main():
    ...
    parser.add_argument(
        "-e", "--episodes", type=int, default=10, help="Number of episodes to evaluate."
    )
    parser.add_argument(
        "-g", "--game_size", type=int, default=16, help="Size of the game grid (N x N)."
    )
    parser.add_argument(
        "--use-frame-stack",
        action="store_true",
    ...
    parser.add_argument(
        "--n_stack", type=int, default=4, help="Number of frames to stack."
    )
    parser.add_argument(
        "-f",
        "--no-fast-game",
